...
export default function SignupPage() {
  ...
  function handleSignup(e: MouseEventHandler<HTMLButtonElement>) {
    Api.SignupUser(loginData);
  }
      ...
      <div className="bg-white rounded-lg shadow-xl p-8 w-full max-w-md">
        ...
        <div className="space-y-4">
          ...
          <button
            ...
            className="w-full bg-[#FDB913] text-[#1565C0] font-semibold py-3 rounded-md hover:bg-[#E5A812] transition"
          >
            Sign Up
          </button>
        </div>
